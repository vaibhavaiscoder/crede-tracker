...
import 'package:ctrackdev/constants/company_data.dart';
import 'package:ctrackdev/widgets_common/custom_alert_dialog.dart';
import 'package:ctrackdev/widgets_common/custom_toast.dart';
...
class PresenceController extends GetxController {
  ...
  presence() async {
    ...
    if (!determinePosition["error"]) {
      ...
      isLoading.value = false;
      Get.snackbar("Error", determinePosition["message"]);
  ...
  firstPresence(
    ...
    CustomAlertDialog.showPresenceAlert(
      title: "Are you want to add driver?",
      ...
      onConfirm: () async {
        ...
        Get.back();
        CustomToast.successToast("Success", "successfully added");
      },
    );
  }
  ...
  checkoutPresence(
    ...
    CustomAlertDialog.showPresenceAlert(
      title: "Are you want to add driver?",
      message: "you need to confirm before\nadding driver",
      onCancel: () => Get.back(),
      onConfirm: () async {
    ...
    if (snapshotPreference.docs.length == 0) {
      ...
      if (todayDoc.exists == true) {
        ...
        if (dataPresenceToday?["keluar"] != null) {
          ...
          CustomToast.successToast("Success", "you already added");
        } else {
